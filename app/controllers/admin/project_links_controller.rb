...
class Admin::ProjectLinksController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     ProjectLink: create, read, update, destroy, custom_action
  #
  #   editor:
  #     ProjectLink: create, read, update, custom_action_for_an_item
  #
