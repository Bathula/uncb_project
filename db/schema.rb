...
ActiveRecord::Schema.define(:version => 20120914151619) do
  ...
  create_table "imessage_recipients", :force => true do |t|
  ...
  create_table "interests", :force => true do |t|
    ...
    t.boolean  "join_project",  :default => true, :null => false
    t.boolean  "like_to",       :default => true, :null => false
    t.boolean  "blog_post",     :default => true, :null => false
  ...
  create_table "memberships", :force => true do |t|
    ...
    t.boolean  "blog_post",     :default => true,  :null => false
    t.boolean  "comments",      :default => true,  :null => false
    t.string   "like_to_join",                     :null => false
    t.boolean  "open_join",     :default => true,  :null => false
  end
  ...
  add_index "message_attachments", ["attachable_id", "attachable_type"], :name => "index_message_attachments_on_attachable_id_and_attachable_type"
  ...
  create_table "projectcategories", :force => true do |t|
    t.string   "name",        :null => false
    t.string   "description", :null => false
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "projects", :force => true do |t|
    ...
    t.integer  "projectcategory_id",                                        :null => false
    t.boolean  "delta",                                 :default => true,   :null => false
    t.float    "rating_cache"
    t.integer  "rating_count_cache"
    t.float    "rating_cache_pro"
    t.integer  "rating_count_cache_pro"
    t.string   "batch_id"
  end
  ...
  create_table "ratings", :force => true do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "average_rating_pro"
    t.integer  "ratings_count_pro"
  end
