...
(function() {
	...
	window.addEvent("domready", function() {
		...
		bottom = new Element("div", {id: "mbBottom"}).injectInside(center).adopt(
			...
			blooga = new Element("div", {style: "clear:both;"}),
	...
	Mediabox = {
		...
		open: function(_images, startImage, _options) {
			options = $extend({
				...
				defaultWidth: 700,				// Default width of the box (in pixels) for undefined media (MP4, FLV, etc.)
...
//			NonverBlaster
				...
				playerpath: '/javascripts/NonverBlaster.swf',	// Path to NonverBlaster.swf
				controlColor: '0x000000',	// set the controlbar color
